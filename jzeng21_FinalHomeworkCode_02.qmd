...
3\) One of my current biggest challenge right now is actually still working on how to make my homework look pretty and also I am having trouble working on integration of github. I am still trying to figure out on how to push proper peer comments and how to push seperate files in differentiating the final vs original homework code. Git hub is my biggest challenge currently
